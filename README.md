...
I don't know how to use the readme.md....
Yes it could be optmized a lot, and i will do it in due time

This is a simple program that allows you quickly adjust the volume of any specific application on you computer (sadly it only works on windows for now)
